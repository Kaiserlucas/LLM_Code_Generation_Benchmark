...
public class VendingMachineLlama3Tests {
    ...
    private List<VendingMachine.Product> getBaseProducts() {
        ...
        VendingMachine.Product product1 = new VendingMachineLlama3.ProductImpl("Water", 0.99, 3);
        VendingMachine.Product product2 = new VendingMachineLlama3.ProductImpl("Cookie", 2.50, 1);
        VendingMachine.Product product3 = new VendingMachineLlama3.ProductImpl("Bubblegum", 1.99, 5);
    ...
    private List<VendingMachine.Product> getCakeProduct() {
        ...
        VendingMachine.Product cake = new VendingMachineLlama3.ProductImpl("Cake", 3.99, 1);
        cakeList.add(cake);
