...
public class VendingMachineBingTests {
    ...
    private List<VendingMachine.Product> getBaseProducts() {
        ...
        VendingMachine.Product product1 = new VendingMachineBing.ProductImpl("Water", 0.99, 3);
        VendingMachine.Product product2 = new VendingMachineBing.ProductImpl("Cookie", 2.50, 1);
        VendingMachine.Product product3 = new VendingMachineBing.ProductImpl("Bubblegum", 1.99, 5);
    ...
    private List<VendingMachine.Product> getCakeProduct() {
        ...
        VendingMachine.Product cake = new VendingMachineBing.ProductImpl("Cake", 3.99, 1);
        cakeList.add(cake);
