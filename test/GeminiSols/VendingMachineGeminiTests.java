...
public class VendingMachineGeminiTests {
    ...
    private List<VendingMachine.Product> getBaseProducts() {
        ...
        VendingMachine.Product product1 = new VendingMachineGemini.ProductImpl("Water", 0.99, 3);
        VendingMachine.Product product2 = new VendingMachineGemini.ProductImpl("Cookie", 2.50, 1);
        VendingMachine.Product product3 = new VendingMachineGemini.ProductImpl("Bubblegum", 1.99, 5);
    ...
    private List<VendingMachine.Product> getCakeProduct() {
        ...
        VendingMachine.Product cake = new VendingMachineGemini.ProductImpl("Cake", 3.99, 1);
        cakeList.add(cake);
